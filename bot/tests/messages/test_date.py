...
class TestOtherDateMessage:
    ...
    def test_get_viber_buttons__middle(self):
        ...
        assert buttons[0]['data'] == '22.02.2018'
        assert buttons[10]['data'] == '04.03.2018'
    ...
    def test_get_viber_buttons__start(self):
        ...
        assert buttons[0]['data'] == '01.01.2018'
        assert buttons[13]['data'] == '14.01.2018'
    ...
    def test_get_viber_buttons__end(self):
        ...
        assert buttons[0]['data'] == '07.01.2018'
        assert buttons[7]['data'] == '14.01.2018'